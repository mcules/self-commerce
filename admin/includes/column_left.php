...
if (($_SESSION['customers_status']['customers_status_id'] == '0') && ($admin_access['haendlerbund'] == '1')) $box_extra_modules .= '<a href="' . xtc_href_link("haendlerbund.php", '') . '" class="menuBoxContentLink"> -' . 'AGB Service' . '</a><br />';
