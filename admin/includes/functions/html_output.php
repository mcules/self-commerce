<?php
/* --------------------------------------------------------------
   $Id: html_output.php 17 2012-06-04 20:33:29Z deisold $   
...
defined( '_VALID_XTC' ) or die( 'Direct Access to this location is not allowed.' );
  ...
  function xtc_sorting($page,$sort) {
      ...
      switch ($page) {
          ...
          case FILENAME_STOCK_LIST: 
 
          $nav='<br><div><a href="'.xtc_href_link(FILENAME_STOCK_LIST,'sorting='.$sort.'&'.xtc_get_all_get_params(array('action','sorting'))).'">'; 
          $nav.=xtc_image(DIR_WS_ICONS . 'sort_down.gif', '', '20' ,'20').'</a>'; 
          $nav.='<a href="'.xtc_href_link(FILENAME_STOCK_LIST,'sorting='.$sort.'-desc&'.xtc_get_all_get_params(array('action','sorting'))).'">'; 
          $nav.= xtc_image(DIR_WS_ICONS . 'sort_up.gif', '', '20' ,'20').'</a></div>'; 
