JTL-Wawi Connector für xt:Commerce
===================================

JTL-Wawi Connector ist ein kostenloses Modul für den Shop xt:Commerce, um automatische Synchronisation zwischen der kostenlosen Warenwirtschaft JTL-Wawi und xt:Commerce zu ermöglichen.
...
3. Rufen Sie mit einem Browser http://IhreShopDomain.de/admin/includes/modules/jtlwawi_connector/install/index.php auf, treffen Sie dort Ihre Einstellungen und drücken auf Installieren. Notieren Sie sich die Einstellungen, die Sie in JTL-Wawi eintragen müssen unter Einstellungen->Shop-Einstellungen.
