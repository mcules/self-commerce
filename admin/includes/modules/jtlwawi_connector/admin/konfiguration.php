...
function zeigeKonfigForm()
{
						...
						<td bgcolor="#ffffff" style="border-color:#222222; border-width:1px; border-style:solid; border-top-width:0px; border-bottom-width:0px; border-left-width:0px;" valign="top" align="center" height="400"><br>
							<table cellspacing="0" cellpadding="0" width="96%">
								...
								<tr><td class="content" align="center"><br>
										Für den reibungslosen Im-/ und Export von Daten zwischen <a href="http://www.jtl-software.de">JTL-Wawi</a> und Ihrem Shop, müssen einige Einstellungen als Standard gesetzt sein.<br><br>
	...
	echo('
													...
													JTL-Wawi kennt nur die Kundengruppen Endkunde und Händlerkunde. Weisen Sie diesen Kundengruppen Ihre Shop-Kundengruppen zu - dies ist für die korrekte Preiszuordnung unerlässlich. Vergeben Sie nicht Ihre Kundengruppen doppelt.<br>
													<table cellspacing="0" cellpadding="10" width="100%">
														<tr>
