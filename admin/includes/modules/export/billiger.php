<?php
/* -----------------------------------------------------------------------------------------
   $Id: billiger.php 17 2012-06-04 20:33:29Z deisold $
...
// include needed functions
  ...
  class billiger {
    ...
    function process($file) {
        ...
        $schema = 'artikelid;herstelller;bezeichnung;kategorie;beschreibung_kurz;beschreibung_lang;bild_klein;deeplink;preis_val;product_ean'."\n";
