<?php
/* --------------------------------------------------------------
   $Id: manufacturers.php 17 2012-06-04 20:33:29Z deisold $   
...
// end http://
        $sql_data_array = array('manufacturers_url' => $post_manu_url);
...
<?php
  ...
  switch ($_GET['action']) {
    ...
    if($mInfo->manufacturers_image) 
      	$contents[] = array('text' => '<br />' . xtc_draw_checkbox_field('delete_image','on',false) . TEXT_DELETE_IMAGE);      
