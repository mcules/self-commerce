<?php
/* -----------------------------------------------------------------------------------------
   $Id: content_preview.php 17 2012-06-04 20:33:29Z deisold $   
...
if ($_GET['pID']=='media') {
	// display image
	if (preg_match('/.gif/i',$content_data['content_file']) || preg_match('/.jpg/i',$content_data['content_file']) ||  preg_match('/.png/i',$content_data['content_file']) ||  preg_match('/.tif/i',$content_data['content_file']) ||  preg_match('/.bmp/i',$content_data['content_file'])) {	
