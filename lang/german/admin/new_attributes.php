<?php
/* --------------------------------------------------------------
   $Id: new_attributes.php 17 2012-06-04 20:33:29Z deisold $
   ...
   define('ATTR_PREFIXWEIGHT','Präfix Gewicht');
   define('ATTR_PRICE','Preis');
   define('ATTR_PREFIXPRICE','Präfix Preis');
   define('DL_COUNT','Mögl. Downloads:');
