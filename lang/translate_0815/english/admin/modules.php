...
// PayPal Express
define('TEXT_INFO_DELETE_PAYPAL', 'If you deinstall this module now, the PayPal transaction data are deleted!<br />If you want to receive these data, press now on abort and you deactivate the module (activate module = False) only.');