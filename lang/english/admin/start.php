...
define('HOST','Host');
define('WARNING_INSTALL_DIRECTORY_EXISTS', 'Warning: The installation directory is still available on: /self_installer. Please delete this directory for security reasons!');