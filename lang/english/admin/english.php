...
define('BOX_HEADING_EXTRA_MODULES','Extra Modules');
...
define('SELECT_ALL', 'select all/none: ');
...
define('BOX_CONFIGURATION_358', 'Ebay Options');
define('BOX_CONFIGURATION_359', 'Tiny_MCE Options');
