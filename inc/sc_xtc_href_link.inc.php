<?php
/* --------------------------------------------------------------
   gm_xtc_href_link.inc.php 2008-05-16 gambio
   Gambio OHG
   http://www.gambio.de
   ...
   (c) 2003 XT-Commerce - community made shopping http://www.xt-commerce.com ($Id: sc_xtc_href_link.inc.php 17 2012-06-04 20:33:29Z deisold $)

   Released under the GNU General Public License
   ---------------------------------------------------------------------------------------*/

// The HTML href link wrapper function
  function sc_xtc_href_link($page = '', $parameters = '', $connection = 'NONSSL', $add_session_id = false, $search_engine_safe = true) {
