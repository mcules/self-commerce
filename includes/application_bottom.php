...
/* -----------------------------------------------------------------------------------------
  ...
  if (GOOGLE_ANAL_ON == 'true' && GOOGLE_ANAL_CODE != '')echo '<script src="http://www.google-analytics.com/urchin.js" type="text/javascript"></script><script type="text/javascript">_uacct = "'.GOOGLE_ANAL_CODE.'";urchinTracker();</script>';  
  echo '</body></html>';  
?>
