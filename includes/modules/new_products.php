...
/* -----------------------------------------------------------------------------------------
   $Id: new_products.php 17 2012-06-04 20:33:29Z deisold $
...
while ($new_products = xtc_db_fetch_array($new_products_query, true)) {
	$module_content[] = $product->buildDataArray2($new_products);
...
var mySlideData = new Array();';
  ...
  $scriptend = '</script>
<center><div class="jdSlideshow" id="mySlideshow"></div></center>
...
';
	...
	$module_smarty->assign('scriptend', $scriptend);
//slideshow
