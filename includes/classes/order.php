<?php
/* -----------------------------------------------------------------------------------------
   $Id: order.php 63 2012-10-20 17:29:32Z McUles $
...
class order {
    ...
    function query($order_id) {
        ...
        // PayPal APIModul / Paypal Express Modul
        ...
        $this->delivery = array('name' => $order['delivery_name'],
            ...
            'country_iso_2' => $order['delivery_country_iso_code_2'], // PayPal IPN Link / Paypal Express Modul
        ...
        $this->billing = array('name' => $order['billing_name'],
            ...
            'country_iso_2' => $order['billing_country_iso_code_2'], //ADD - PayPal IPN Link / Paypal Express Modul
        ...
        while ($orders_products = xtc_db_fetch_array($orders_products_query)) {
            ...
            $attributes_query = xtc_db_query("SELECT *
                                          ...
                                          ORDER BY orders_products_attributes_id"); //ADD - order by orders_products_attributes_id
    ...
    function getTotalData($oID) {
        ...
        while ($order_total_values = xtc_db_fetch_array($order_total_query)) {
            ...
            if ($order_total_values['class'] == 'ot_shipping') {
                $shipping = $order_total_values['value']; // PayPal IPN Link in Kundenaccount
            }
        }
    ...
    function cart() {
        ...
        for ($i=0; $i<$n; $i++) {
            ...
            if ($_SESSION['customers_status']['customers_status_show_price_tax'] == '1') {
                ...
                if (!isset($this->info['tax_groups'][$tax_index])) $this->info['tax_groups'][$tax_index] = 0; //DokuMan - 2010-09-28 - set undefined index
                if ($_SESSION['customers_status']['customers_status_ot_discount_flag'] == 1) {
