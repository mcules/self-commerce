...
xtc_db_query("INSERT INTO zones_to_geo_zones (association_id, zone_country_id, zone_id, geo_zone_id, last_modified, date_added) VALUES (239, 239, 0, 6, NULL, now())");
	      ...
	      xtc_redirect(xtc_href_link('self_installer/install_step7.php', '', 'NONSSL'));
		}
...
<html>
<head>
<title>Self-Commerce Installer - STEP 6 / Create Superuser</title>
...
<table class="mainTable" border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr> 
      		...
      		<table width="180" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td class="left_top" colspan="2">
		             <?php echo $messageStack->output('install_step6'); ?>
				</td>
				</tr>
	            <?php
				  }
		...
		<td align="right" valign="top" class="frame2" width="100%">
			<h2 class="welcome"><?php echo TEXT_WELCOME_STEP6; ?></h2><hr class="lineBlue"> 
				...
				<tr> 
					<td>
						<form name="install" action="install_step6.php" method="post" onSubmit="return check_form(install_step6);">
              			...
              			<span class="title"><?php echo TITLE_ADMIN_CONFIG; ?> </span><span class="note_red_title"><?php echo TEXT_REQU_INFORMATION; ?></span><hr class="lineRed">
			  			<span class="note"><?php echo   TITLE_ADMIN_CONFIG_NOTE; ?></span>
              			<table width="100%" border="0">
                			...
                			<tr> 
                  				...
                  				<td class="small"><?php echo xtc_draw_input_field_installer('LAST_NAME'); ?><span class="note_red">*</span></td>
			                </tr>
			                <tr> 
                  				<td class="small_strong"><?php echo TEXT_EMAIL; ?></td>
                  				<td class="small"><?php echo xtc_draw_input_field_installer('EMAIL_ADRESS'); ?><span class="note_red">*</span>&nbsp;<span class="note"><?php echo TEXT_EMAIL_LONG; ?></span></td>
                			</tr>
			                <tr> 
			                  	<td class="small_strong"><?php echo TEXT_STREET; ?></td>
			                  	<td class="small"><?php echo xtc_draw_input_field_installer('STREET_ADRESS'); ?><span class="note_red">*</span></td>
			                </tr>
			                <tr> 
			                  	<td class="small_strong"><?php echo TEXT_POSTCODE; ?></td>
			                  	<td class="small"><?php echo xtc_draw_input_field_installer('POST_CODE'); ?><span class="note_red">*</span></td>
			                </tr>
			                <tr> 
			                  	<td class="small_strong"><?php echo TEXT_CITY; ?></td>
			                  	<td class="small"><?php echo xtc_draw_input_field_installer('CITY'); ?><span class="note_red">*</span></td>
			                </tr>
							<tr> 
			                  	<td class="small_strong"><?php echo TEXT_STATE; ?></td>
			                  	<td class="small">
			                    <?php
			    if ($process == true) {
			      if ($entry_state_has_zones == true) {
			...
			?>
			                    <span class="note_red">*</span></td>
							</tr>
			                <tr> 
			                  	<td class="small_strong"><?php echo TEXT_COUNTRY; ?></td>
			                  	<td class="small"><?php echo xtc_get_country_list('COUNTRY'); ?><span class="note_red">*</span>&nbsp;<span class="note"><?php echo TEXT_COUNTRY_LONG; ?></span></td>
			                </tr>
			                <tr> 
			                  	<td class="small_strong"><?php echo TEXT_TEL; ?></td>
			                  	<td class="small"><?php echo xtc_draw_input_field_installer('TELEPHONE'); ?><span class="note_red">*</span></td>
			                </tr>
			                <tr> 
			                  	<td class="small_strong"><?php echo TEXT_PASSWORD; ?></td>
			                  	<td class="small"><?php echo xtc_draw_password_field_installer('PASSWORD'); ?><span class="note_red">*</span>&nbsp;<span class="note"><?php echo TEXT_PASSWORD_LONG1; ?></span></td>
			                </tr>
			                <tr> 
			                  	<td class="small_strong"><?php echo TEXT_PASSWORD_CONF; ?></td>
			                  	<td class="small"><?php echo xtc_draw_password_field_installer('PASSWORD_CONFIRMATION'); ?><span class="note_red">*</span></td>
			                </tr>
						</table>
						<br /><br />
						<span class="title"><?php echo TITLE_SHOP_CONFIG; ?> </span><span class="note_red_title"><?php echo TEXT_REQU_INFORMATION; ?></span><hr class="lineRed">
						<span class="note"><?php echo  TITLE_SHOP_CONFIG_NOTE; ?></span><br />
						<table width="100%" border="0">
			                <tr> 
			                  	<td class="small_strong" width="26%"><?php echo  TEXT_STORE; ?></td>
			                  	<td class="small" width="74%"><?php echo xtc_draw_input_field_installer('STORE_NAME'); ?><span class="note_red">*</span>&nbsp;<span class="note"><?php echo  TEXT_STORE_LONG; ?></span></td>
			                </tr>
			                <tr> 
			                  	<td class="small_strong"><?php echo  TEXT_COMPANY; ?></td>
			                  	<td class="small"><?php echo xtc_draw_input_field_installer('COMPANY'); ?><span class="note_red">*</span></td>
			                </tr>
			                <tr> 
			                  	<td class="small_strong"><?php echo  TEXT_EMAIL_FROM; ?></td>
			                  	<td class="small"><?php echo xtc_draw_input_field_installer('EMAIL_ADRESS_FROM'); ?><span class="note_red">*</span>&nbsp;<span class="note"><?php echo  TEXT_EMAIL_FROM_LONG; ?></span></td>
			                </tr>
						</table>
			  			<br /><br />
						<span class="title"><?php echo TITLE_ZONE_CONFIG; ?>  </span><span class="note_red_title"><?php echo TEXT_REQU_INFORMATION; ?></span><hr class="lineRed">
						<span class="note"><?php echo  TITLE_ZONE_CONFIG_NOTE; ?></span><br />
						<table width="100%" border="0">
							<tr> 
                  				<td class="small_strong" width="26%"><?php echo  TEXT_ZONE; ?></td>
                  				<td class="small" width="74%"><?php echo  TEXT_ZONE_YES; ?> <?php echo xtc_draw_radio_field_installer('ZONE_SETUP', 'yes', 'true'); ?>&nbsp;&nbsp;
                   				 <?php echo  TEXT_ZONE_NO; ?> <?php echo xtc_draw_radio_field_installer('ZONE_SETUP', 'no'); ?></td>
                			</tr>
              			</table><br /><br />
						<center>
