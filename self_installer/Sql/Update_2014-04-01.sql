ALTER TABLE `products` ADD `products_han` VARCHAR( 30 ) NOT NULL;
ALTER TABLE `products` ADD `suppliers_id` VARCHAR( 30 ) NOT NULL;

CREATE TABLE IF NOT EXISTS `suppliers_info` (
  `suppliers_id` int(11) NOT NULL,
  `suppliers_url` varchar(255) NOT NULL,
  `suppliers_customer_number` varchar(30) NOT NULL,
