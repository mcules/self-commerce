...
define('BOX_UPDATE_DB','Datenbank aktualisieren');
define('BOX_UPDATE_DONE','Update abgeschlossen');
...
// update_step1.php
define('TEXT_UPDATE_1','Bitte setzten Sie die Installation nun fort, um die Datenbank zu aktualisieren.');
define('TEXT_UPDATE_2', 'Bitte klicken Sie jetzt auf "Continue" um die Datenbank zu aktualisieren.');

// update_step2.php
define('TEXT_UPDATE_STEP2_1','Die Datenbank wurde aktualisiert.');
define('TEXT_UPDATE_STEP2_2', 'Sie k&ouml;nnen nun das Setup abschlie&szlig;en.');
define('TEXT_UPDATE_STEP2_TITLE', 'Datenbank aktualisiert');
...
define('TEXT_WELCOME_INDEX','<b>Willkommen zu Self-Commerce</b><br /><br />Self-Commerce ist eine Open-Source e-commerce L&ouml;sung.<br /> Seine out-of-the-box Installation erlaubt es dem Shop-Besitzer seinen Online-Shop mit einem Minimum an Aufwand und Kosten zu installieren, zu betreiben und zu verwalten.<br /><br />Self-Commerce ist auf jedem System lauff&auml;hig, welches eine PHP Umgebung (ab PHP 4.1) und mySQL zur Verf&uuml;gung stellt, wie zum Beispiel Linux, Solaris, BSD, und Microsoft Windows.');
...
define('TEXT_IMPORT_DB_LONG','Importiere die Self-Commerce Datenbankstruktur, welche die Tabellen und Beispieldaten enth&auml;lt.');
...
define('TEXT_USERNAME_LONG','Der Benutzername, der zum konnektieren der Datenbank ben&ouml;tigt wird, wie zum Beispiel <i>mysql_10</i>.<br /><br />Bemerkung: Wenn die Self-Commerce Datenbank Importiert werden soll (wenn oben ausgew&auml;hlt), muss der Benutzer CREATE und DROP Rechte f&uuml;r die Datenbank haben. Sollten hier Probleme auftreten, kann Ihnen Ihr Provider weiterhelfen.');
...
define('TEXT_SESS_LONG','Das Verzeichnis, in welches PHP die Session-Dateien speichert.<br />Um Probleme zu vermeiden sollte <b>Speichere Sessions in der Datenbank</b> gew&auml;hlt werden.');
...
define('TEXT_EMAIL_LONG','E-Mail Adresse, an die eine separate Mail bei Bestellungen gesendet werden soll. Wird auch zum Login im Shop ben&ouml;tigt!');
...
define('TEXT_PASSWORD','Passwort:');
define('TEXT_PASSWORD_LONG1','Wird zum Login im Shop ben&ouml;tigt!');
define('TEXT_PASSWORD_CONF','Passwort Best&ouml;tigung:');
...
define('TITLE_SHOP_CONFIG_NOTE','*Note; Information f&uuml;r grundlegende Shopeinstellungen');
...
define('TEXT_TEAM','Vielen Dank, dass Sie sich f&uuml;r Self-Commerce entschieden haben. Besuchen Sie uns im Forum: <b><a href="http://www.self-commerce.de">http://www.self-commerce.de</a></b><br />Alles Gute und viel Erfolg w&uuml;nschen Ihnen die Nutzer des <b>self-commerce.de</b> Forums.');
?>