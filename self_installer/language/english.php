...
define('TEXT_WELCOME_STEP4','<b>Configure Self-Commerce main files</b><br /><br /><b>If there are old configure files from a further installation, Self-Commerce wiill delete them</b><br /><br />The installer will set up the configuration files with the main parameters for database and file structur.<br /><br />You can choose between different session handling systems.');
define('TEXT_WELCOME_STEP5','<b>Webserver Configuration</b><br /><br />');
define('TEXT_WELCOME_STEP6','<b>Basic shop configuration</b><br /><br />The installer will create the admin account and will perform some db actions.<br /> The given informations for <b>Country</b> and <b>Post Code</b> are used for shipping and tax callculations.<br /><br />If you wish, self-commerce can automatically setup the zones,tax-rates and tax-classes for delivering/selling within the European Union.<br />Just set <b>setup zones for EU</b> to <b>YES</b>.');
define('TEXT_WELCOME_STEP7','<b>Guest and default customers setup</b><br /><br />The Self-Commerce group- and pricesystem got nearly infinite possibilities of different prices.<br /><br />
...
define('TEXT_AUTOMATIC_LONG','The information you submit regarding the web server and database server will be automatically saved into both Self-Commerce Shop and Administration Tool configuration files.');
...
define('TEXT_USERNAME_LONG','The username is used to connect to the database server. An example username is <i>mysql_10</i>.<br /><br />Note: If the self-commerce Database is to be imported (selected above), the account used to connect to the database server needs to have Create and Drop permissions.');
...
define('TEXT_DATABASE_LONG','The database used to hold the catalog data. An example database name is <i>self-commerce</i>.<br /><b>ATTENTION:</b> Self-Commerce need an empty Database to perform Installation.');
...
define('TEXT_WS_XTC','Webserver "Self-Commerce" Directory');
define('TEXT_WS_XTC_LONG','The directory where your catalog pages are being served from (from the webserver root directory), usually <i>/home/myname/public_html<b>/selfcommerce/</b></i>.');
define('TEXT_WS_ADMIN','Webserver Administration Tool Directory');
define('TEXT_WS_ADMIN_LONG','The directory where your administration tool pages are being served from (from the webserver root directory), usually <i>/home/myname/public_html<b>/selfcommerce/admin/</b></i>.');
define('TEXT_WS_CATALOG','WWW Catalog Directory');
define('TEXT_WS_CATALOG_LONG','The virtual directory where the Self-Commerce Catalog module resides, usually <i>/selfcommerce/</i>.');
...
define('TITLE_ZONE_CONFIG_NOTE','*Note; self-commerce can automatically setup the right Zone-Setup if your store is located within the EU.');
