                                        ...
                                        LIMIT ".MAX_RANDOM_SELECT_NEW))
{
  ...
  $box_smarty->assign('language', $_SESSION['language']);
      ...
      // Aufruf Link im Header
    $box_whats_new_header = $box_smarty->fetch(CURRENT_TEMPLATE.'/boxes/box_whats_new_header.html');
    $smarty->assign('box_WHATS_NEW_HEADER', $box_whats_new_header);
