...
$box_smarty->assign('INPUT_SEARCH', xtc_draw_input_field('keywords', 'Suchbegriff ...', 'class="flatSearch" size="15" maxlength="30" onclick="if(this.value==this.defaultValue) this.value=\'\';return false" onblur="if(this.value.replace(/\s/g, \'\') ==\'\' ) this.value=this.defaultValue; return false"'));
$box_smarty->assign('BUTTON_SUBMIT', xtc_image_submit('button_quick_find_box.gif', BOX_HEADING_SEARCH));
