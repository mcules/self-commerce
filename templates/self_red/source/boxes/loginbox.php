...
if (!xtc_session_is_registered('customer_id')) {
	...
	$box_smarty->assign('FIELD_EMAIL', xtc_draw_input_field('email_address', 'eMail oder Kdn-Nr.', 'size="25" maxlength="50" onclick="if(this.value==this.defaultValue) this.value=\'\';return false" onblur="if(this.value.replace(/\s/g, \'\') ==\'\' ) this.value=this.defaultValue; return false"'));
