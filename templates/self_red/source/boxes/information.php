...
$content_string = '<ul  id="box_information">';
...
$box_smarty->assign('NEWSLETTER', '<ul  id="box_information"><li> <a href="' . xtc_href_link(FILENAME_NEWSLETTER, '', 'NONSSL') . '">Newsletter</a></li></ul>');
