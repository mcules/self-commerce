...
/* -----------------------------------------------------------------------------------------
   ...
   (c) 2002-2003 osCommerce(extra1.php,v 1.6 2003/02/10); www.oscommerce.com
   (c) 2003	 nextcommerce (extra1.php,v 1.8 2003/08/21); www.nextcommerce.org
...
if (!$box_smarty->iscached(CURRENT_TEMPLATE.'/boxes/box_extra1.html', $cache_id) || !$cache) {
...
require_once (DIR_FS_INC . 'shop_content.php');
                 ...
                 */
$content_string .= shop_content($_SESSION['languages_id'], 3, 0, 'box_extra1', MODULE_CONTENT_MANAGER_CHILDREN_SHOW);
