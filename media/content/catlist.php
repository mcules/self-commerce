<?php
/* -----------------------------------------------------------------------------------------
   $Id: catlist.php 17 2012-06-04 20:33:29Z deisold $
...
$categories_query = "select c.categories_image, c.categories_id, cd.categories_name
					FROM " . TABLE_CATEGORIES . " c left join " . TABLE_CATEGORIES_DESCRIPTION ." cd on c.categories_id = cd.categories_id
					WHERE c.categories_status = '1' and cd.language_id = ".$_SESSION['languages_id'] . " and c.parent_id = '0' ".$group_check." order by c.sort_order ASC";
...
if($_SESSION['language'] == "german") {
	$fehler = array(
		404 => 'Fehler 404: Die gesuchte Seite wurde nicht gefunden!',
